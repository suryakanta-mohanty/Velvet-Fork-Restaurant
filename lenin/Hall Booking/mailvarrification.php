...
<body>
    <form method="POST" action="mailvarrification.php" class="verification-container">
        <h2>Email Verification</h2>
        <p>Verification code has been sent to: <strong id="user-email"><?php echo $_SESSION['user_email']; ?></strong></p>
...
// Use isset() to check if OTP key exists
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if ($entered_otp == $session_otp) {
        ...
        echo "<script>window.location.href='process_booking.php';</script>";
        exit;

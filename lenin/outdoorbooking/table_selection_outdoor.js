document.addEventListener("DOMContentLoaded", function (){
    ...
    generateTables("four-seater", "4", 6);
    generateTables("two-seater", "2", 10);
    ...
    function tableClickHandler() {
        if (!this.classList.contains("booked")) {
            ...
            window.location.href = `outdoor_bookingform.html?table_id=${tableId}&date=${date}&fromTime=${fromTime}&toTime=${toTime}`;
        } else {
    ...
    window.checkAvailability = function () {
        ...
        fetch("check_availability_outdoor.php", {
            method: "POST",
            headers: {
